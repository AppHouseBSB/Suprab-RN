...
export default function Main({navigation}) {
  ...
  //     estado: 'DF',
  //     CEP: '71535-015',
  //     telefoneCelular: '61999816906',
  //     telefoneFixo: '6133685955',
    ...
    <View style={styles.container}>
      <View style={styles.containerDados}>
        ...
        <View style={styles.containerDetalhe}>
          <Text style={styles.titulo}>Ruy Ferreira Borges</Text>
          <Text style={styles.tituloSub}>CGP: 033 Grau: Maçônico 33</Text>
          ...
          <ScrollView style={styles.containerMigalha}>
            <View style={styles.containerTitulo}>
              <Text style={styles.limiteTitulo}>Dados Pessoais</Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Nome Completo: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].nome.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Nome Histórico: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].nomeHistorico.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Data de Nascimento: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].dataNascimento}
              </Text>
              <Text style={styles.subTitulo}>{'      '}Tipo Sanguíneo: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].tipoSanguineo.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>CIM: </Text>
              <Text style={styles.subTituloDados}>{dados[0].cim}</Text>
              <Text style={styles.subTitulo}>{'      '}CPF: </Text>
              <Text style={styles.subTituloDados}>{dados[0].cpf}</Text>
              <Text style={styles.subTitulo}>{'      '}Grau Maçônico: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].grauMaconico}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Cidade: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].cidadeNascimento.toUpperCase()}
              </Text>
              <Text style={styles.subTitulo}>{'      '}UF: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].ufNascimento.toUpperCase()}
              </Text>
            </View>
            <View style={styles.containerTitulo}>
              <Text style={styles.limiteTitulo}>Informações de contato</Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Endereço Residencial: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].endereco.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Bairo: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].bairo.toUpperCase()}
              </Text>
              <Text style={styles.subTitulo}>{'      '}Cidade: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].cidade.toUpperCase()}
              </Text>
              <Text style={styles.subTitulo}>{'      '}UF: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].estado.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Celular: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].telefoneCelular}
              </Text>
              <Text style={styles.subTitulo}>{'      '}Fixo: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].telefoneFixo}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>E-mail: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].email.toUpperCase()}
              </Text>
            </View>
            <View style={styles.containerTitulo}>
              <Text style={styles.limiteTitulo}>Dados maçônicos</Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Loja/Lodge: </Text>
              <Text style={styles.subTituloDados}>{dados[0].lojaLodge}</Text>
              <Text style={styles.subTitulo}>{' - '}</Text>
              <Text style={styles.subTituloDados}>
                {dados[0].nomeLoja.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Título Honorífico: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].titulo.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Cargo: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].cargo.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Potência da Loja: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].potenciaLoja.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Cidade: </Text>
              <Text style={styles.subTituloDados}>{dados[0].cidadeLoja}</Text>
              <Text style={styles.subTitulo}>{'      '}UF: </Text>
              <Text style={styles.subTituloDados}>{dados[0].ufLoja}</Text>
            </View>
            <View style={styles.containerTitulo}>
            ...
            <View style={styles.rowContainer}>
              ...
              <Text style={styles.subTituloDados}>
                {dados[0].numLojaAprendiz}
              </Text>
              <Text style={styles.subTitulo}>{' - '}</Text>
              <Text style={styles.subTituloDados}>
                {dados[0].lojaAprendiz.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Data: </Text>
              <Text style={styles.subTituloDados}>{dados[0].dtAprendiz}</Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Companheiro: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].numLojaCompanheiro}
              </Text>
              <Text style={styles.subTitulo}>{' - '}</Text>
              <Text style={styles.subTituloDados}>
                {dados[0].lojaCompanheiro.toUpperCase()}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Data: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].dtCompanheiro}
              </Text>
            </View>
            <View style={styles.rowContainer}>
              <Text style={styles.subTitulo}>Mestre: </Text>
              <Text style={styles.subTituloDados}>
                {dados[0].numLojaMestre}
              </Text>
              <Text style={styles.subTitulo}>{' - '}</Text>
              <Text style={styles.subTituloDados}>
                {dados[0].lojaCompanheiro.toUpperCase()}
            ...
            {dados[0].grau.map((value, index) => (
              <>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTitulo}>Grau {value.numero}: </Text>
                </View>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTituloDados}>
                    {value.data}
                  ...
                  <Text style={styles.subTituloDados}>{value.corpo}</Text>
                </View>
              </>
            ))}
