            ...
            />*/}
              <ScrollView
                ...
                <View style={styles.rowContainer}>
                  ...
                  <Text style={styles.subTitulodata}>{data.dataNascimento}</Text>
                </View>
                <View style={styles.rowContainer}>
                ...
                <View style={styles.rowContainer}>
                  ...
                  <Text style={styles.subTitulodata}>{data?.endereco?.cidade}</Text>
                </View>
                <View style={styles.rowContainer}>
                  ...
                  <>
                    ...
                    <View style={styles.rowContainer}>
                      <Text style={styles.subTitulo}>
                        Grau {value.grau}: {value.dataGrau}
                      </Text>
                    </View>
                  </>
                ))}
