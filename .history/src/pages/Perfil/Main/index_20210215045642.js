        ...
        <View style={styles.container}>
          <View style={styles.containerDados}>
            ...
            <View style={styles.containerDetalhe}>
              ...
              <Text style={styles.tituloSub}>{dados.cgp}</Text>
            ...
            <Text style={styles.tituloSub}>
              ...
              <ScrollView style={styles.containerMigalha}>
                ...
                <View style={styles.rowContainer}>
                  ...
                  <Text style={styles.subTituloDados}>{data.cpf}</Text>
                </View>
                <View style={styles.rowContainer}>
                ...
                <Text style={styles.subTituloDados}>{dados.cim}</Text>
                <Text style={styles.subTitulo}>{'      '}CPF: </Text>
                <Text style={styles.subTituloDados}>{dados.cpf}</Text>
                <Text style={styles.subTitulo}>{'      '}Grau Maçônico: </Text>
                <Text style={styles.subTituloDados}>{dados.grauMaconico}</Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Cidade: </Text>
                <Text style={styles.subTituloDados}>
                  {dados.cidadeNascimento.toUpperCase()}
                </Text>
                <Text style={styles.subTitulo}>{'      '}UF: </Text>
                <Text style={styles.subTituloDados}>
                  {dados.ufNascimento.toUpperCase()}
                </Text>
              </View> */}
                <View style={styles.containerTitulo}>
                ...
                <View style={styles.rowContainer}>
                  ...
                  <Text style={styles.subTituloDados}>
                    {dados.endereco.toUpperCase()}
                  </Text>
                </View>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTitulo}>Bairo: </Text>
                  <Text style={styles.subTituloDados}>
                    {dados.bairo.toUpperCase()}
                  </Text>
                </View>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTitulo}>Cidade: </Text>
                  <Text style={styles.subTituloDados}>
                    {dados.cidade.toUpperCase()}
                  </Text>
                </View>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTitulo}>UF: </Text>
                  <Text style={styles.subTituloDados}>
                    {dados.estado.toUpperCase()}
                  </Text>
                </View>
                <View style={styles.rowContainer}>
                  <Text style={styles.subTitulo}>CEP: </Text>
                  <Text style={styles.subTituloDados}>{dados.CEP}</Text>
                </View>
                {/* <View style={styles.containerTitulo}>
              ...
              <View style={styles.rowContainer}>
                ...
                <Text style={styles.subTituloDados}>{dados.lojaLodge}</Text>
                <Text style={styles.subTitulo}>{' - '}</Text>
                <Text style={styles.subTituloDados}>
                  {dados.nomeLoja.toUpperCase()}
                </Text>
              </View>
              <View style={styles.rowContainer}>
              ...
              <View style={styles.rowContainer}>
                ...
                <Text style={styles.subTituloDados}>
                  {dados.cargo.toUpperCase()}
                </Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Potência da Loja: </Text>
                <Text style={styles.subTituloDados}>
                  {dados.potenciaLoja.toUpperCase()}
                </Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Cidade: </Text>
                <Text style={styles.subTituloDados}>{dados.cidadeLoja}</Text>
                <Text style={styles.subTitulo}>{'      '}UF: </Text>
                <Text style={styles.subTituloDados}>{dados.ufLoja}</Text>
              </View> */}
                {/* <View style={styles.containerTitulo}>
              ...
              <View style={styles.rowContainer}>
                ...
                <Text style={styles.subTituloDados}>
                  {dados.numLojaAprendiz}
                </Text>
                <Text style={styles.subTitulo}>{' - '}</Text>
                <Text style={styles.subTituloDados}>
                  {dados.lojaAprendiz.toUpperCase()}
                </Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Data: </Text>
                <Text style={styles.subTituloDados}>{dados.dtAprendiz}</Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Companheiro: </Text>
                <Text style={styles.subTituloDados}>
                  {dados.numLojaCompanheiro}
                </Text>
                <Text style={styles.subTitulo}>{' - '}</Text>
                <Text style={styles.subTituloDados}>
                  {dados.lojaCompanheiro.toUpperCase()}
                </Text>
              </View>
              <View style={styles.rowContainer}>
                <Text style={styles.subTitulo}>Data: </Text>
