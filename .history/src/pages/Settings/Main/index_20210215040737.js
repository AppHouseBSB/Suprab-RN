...
export default function Main({navigation}) {
  ...
  async function enviarMsg() {
    ...
    const body = {
      ...
      mensagem: `<html><head><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head>
      <body>
      <table>       
      <tr>
      <td>
      O colaborador ${data.nome}, CPF n. ${data.cpf}, CGP n. ${data.cgp}, enviou a seguinte ${tipoSelecionado.nome}: /n ${descricao}
      </td>
      </tr>
      </table>
      </body>
