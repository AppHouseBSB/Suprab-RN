...
export default function Main({navigation}) {
  ...
  async function enviarMsg() {
    ...
    if (descricao === '') {
      setErro(true);
      setMsgErro('Descreva sua solicitação!');
      ...
      const body = {
        ...
        mensagem: `<html lang="pt-br"><head><title>Título da página</title><meta charset="utf-8"></head><body>O colaborador ${data.nome}, CPF n. ${data.cpf}, CGP n. ${data.cgp}, enviou a seguinte ${tipoSelecionado.nome}:  ${descricao}</body></html>`,
    ...
    <View style={styles.container}>
      <View style={[styles.button, styles.buttonAccount]}>
        ...
        <View style={styles.buttonText}>
          <Text style={[styles.text, {marginTop: 10}]}>TIPO DE SOLICITAÇÃ0</Text>
          <TouchableOpacity
