  ...
  async function enviarMsg() {
    ...
    if (descricao === '') {
      ...
      const body = {
        ...
        mensagem: `<html lang="pt-br"><head><meta charset="utf-8"></head><body>O colaborador ${data.nome}, CPF n. ${data.cpf}, CGP n. ${data.cgp}, enviou a seguinte ${tipoSelecionado.nome}:  ${descricao}</body></html>`,
